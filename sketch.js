...
function setup() {
  ...
  displayLife = createSprite(displayWidth-1430,displayHeight/3.5);
  ...
  scoreboard = createSprite(displayWidth-300,displayHeight/6,50,50);
...
function spawnObstacles(){
 ...
 function scoreBoard(){
  ...
  fill(0)
  textFont("calibri");
  text("LIFE : " + life , displayWidth-1500,displayHeight/8);

  fill("black");
  textFont("Algerian");
  text("SCORE :" , displayWidth-420,displayHeight/5.5);

  textSize(40);
  text(score, displayWidth-245,displayHeight/5.5);
